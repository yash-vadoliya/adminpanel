                    ...
                    {activeTab === 'booking' && (
                        <>
                            <form onSubmit={fetchData}>
                                <div className="row">
                                    {/* First Row (3 inputs) */}
                                    {['city_id', 'trip_id', 'route_id'].map((field, i) => (
                                ...
                                <div className="row">
                                    {/* Second Row (3 inputs) */}
                                    {['customer_id', 'driver_id', 'vehicle_id'].map((field, i) => (
                                        <div key={i} className="col-md-4 mb-2">
                                            <input
                                                type="text"
                                                name={field}
                                ...
                                <div className="mt-2">
                                    <button className="btn btn-info me-2" type="submit">Load Record</button>
                                        ...
                                        {tableData.length === 0 ? (
                                            ...
                                            tableData.map((row, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    <td>{row.trip_date_from ? new Date(row.trip_date_from).toLocaleDateString() : "-"}</td>
                                                    <td>{row.trip_date_to ? new Date(row.trip_date_to).toLocaleDateString() : "-"}</td>
                                                    <td>{row.trip_fare}</td>
                                                    {/* Driver */}
                                                    <td>{row.driver_id}</td>
                                            ...
                                            tableData.map((row, idx) => (
                                                <tr key={idx}>
                                                    ...
                                                    {/* <td>{row.cancellation_date}</td> */}
                                                     <td>{row.cancellation_date ? new Date(row.cancellation_date).toLocaleDateString() : "-"}</td>
                                                </tr>
                                            ))
                                        )}
                                    </tbody>
